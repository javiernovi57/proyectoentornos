<?php
	...
	$d=rand(0,8);
	for($j=0;$j<9;$j++){
		while($_SESSION['posiciones'][$d]=='O' || $_SESSION['posiciones'][$d]=='X')
		{
			$d=rand(0,8);
		}
	}
...
<body>
    ...
    <div id="casillas">
		...
		<form method="get" action="esenraya.php">
            <?php
            $j = 0;
            for ($i=0; $i<=8; $i++) {
            ...
            ?>
            <br>
            <input class="btn" name="reiniciar" type="submit" value="Reiniciar_partida 1vsPC">
