<?php
	...
	if(isset($_POST['2pj'])){
		if (isset($_SESSION['PJ1']['turno']) == false &&
        isset($_SESSION['PJ2']['turno']) == false){
        $_SESSION['PJ1']['turno'] = false; //true para que comienze el jugador 1
        $_SESSION['PJ1']['ganador'] = false;
        $_SESSION['PJ2']['turno'] = true; //true para que comienze el jugador 2
        $_SESSION['PJ2']['ganador'] = false;
	}}
    ...
    if ($_SESSION['posiciones'][0] === 'X' &&
        ...
        header('Location: gana.php', true, 302);
...
<body>
	...
	<h1>Elige ficha</h1><center>
	<form method="POST" action="resenraya.php">
	<input type="submit" name="1pj" value="x" id="x"/>
	<input type="submit" name="2pj" value="o" id="o"/>
	</form></center>
    <?php
    ...
    ?>
    <div id="casillas">
        <form method="get" action="resenraya.php">
            <?php
            $j = 0;
            for ($i=0; $i<=8; $i++) {
            ...
            ?>
            <br>
            <input class="btn" name="reiniciar" type="submit" value="Reiniciar_partida 1vs1">
			
        </form><br>
		
		<a href="menu.php">
            <input class="btn" type="button" value="Volver menu">
        </a>
    </div>
</body>
</html>